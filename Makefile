all: ace_log_severity_level ace_log_format ace_log_macro \
	ace_log_severity_mask ace_log_stderr ace_log_syslog ace_log_ostream ace_log_redirect
...
ace_log_redirect: ace_log_redirect.cpp
	g++ -g -o ace_log_redirect ace_log_redirect.cpp $(shell pkg-config --cflags --libs ACE)
